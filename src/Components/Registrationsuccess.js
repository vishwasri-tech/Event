...
const RegistrationSuccess1 = () => {
  ...
  const handleDownload = () => {
    ...
    doc.setFontSize(14);
    doc.text("1st Anniversary Event Registration Receipt", 105, 35, {
      align: "center",
    });
    ...
    doc.text("Thank you for your participation!", 105, y + 20, {
      align: "center",
    });
    ...
    <div className="success-container">
      <div className="success-card">
        ...
        <p className="success-message">
          Thank you, {data.name || "Participant"}! Your registration is
          confirmed.
        </p>
        ...
        <div className="details">
          ...
          <span>{data.category || "Competition"}</span>
